...
//
//        mockValidationService.validationError = .validationError
//
...
//            XCTAssertEqual(error as? ShowableError, .emptyTitle)
//        }
//    }
//
...
//        case .failure(let error):
//            XCTAssertEqual(error as? ShowableError, .validationError)
//        }
//    }
//}
